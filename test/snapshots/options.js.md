...
## Valid options | exec {"opts": {"env": [Object]}} (0)
...
## Valid options | exec {"opts": {"env": [Object]}} (1)
...
## Valid options | stream-buffer {"opts": {"env": [Object]}} (0)
...
## Valid options | stream-buffer {"opts": {"env": [Object]}} (1)
...
## Valid options | stream-save {"opts": {"env": [Object]}} (0)
...
## Valid options | stream-save {"opts": {"env": [Object]}} (1)
...
## Valid options | stream-stream {"opts": {"env": [Object]}} (0)
...
## Valid options | stream-stream {"opts": {"env": [Object]}} (1)
...
## Valid options | task {"opts": {"env": [Object]}} (0)
...
## Valid options | task {"opts": {"env": [Object]}} (1)
...
## Default options | exec {"command": "ava --version", "opts": {"env": [Object], "preferLocal": false}}

> Snapshot 1

    {
      exitCode: 1,
      stderr: `Command failed with exit code 2 (ENOENT): ava --version␊
      spawn ava ENOENT␊
          at STACK TRACE`,
      stdout: `[12:00:00] Starting 'main'...␊
      [12:00:00] [gulp-execa] ava --version`,
    }

## Default options | exec {"command": "ava --version", "opts": {"env": [Object]}}
...
## Default options | stream-buffer {"command": "ava --version", "opts": {"env": [Object], "preferLocal": false}}
...
## Default options | stream-buffer {"command": "ava --version", "opts": {"env": [Object]}}
...
## Default options | stream-save {"command": "ava --version", "opts": {"env": [Object], "preferLocal": false}}
...
## Default options | stream-save {"command": "ava --version", "opts": {"env": [Object]}}
...
## Default options | stream-stream {"command": "ava --version", "opts": {"env": [Object], "preferLocal": false}}
...
## Default options | stream-stream {"command": "ava --version", "opts": {"env": [Object]}}
...
## Default options | task {"command": "ava --version", "opts": {"env": [Object], "preferLocal": false}}
...
## Default options | task {"command": "ava --version", "opts": {"env": [Object]}}
