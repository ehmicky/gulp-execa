...
## 'verbose' option | exec { execaOpts: { env: [Object] } }
...
## 'verbose' option | exec { opts: { verbose: true, stdio: 'pipe', stdout: 'pipe', stde...
...
## 'verbose' option | stream-buffer { execaOpts: { env: [Object] } }
...
## 'verbose' option | stream-buffer { opts: { verbose: true, stdio: 'pipe', stdout: 'pipe', stde...
...
## 'verbose' option | stream-save { execaOpts: { env: [Object] } }
...
## 'verbose' option | stream-save { opts: { verbose: true, stdio: 'pipe', stdout: 'pipe', stde...
...
## 'verbose' option | stream-stream { execaOpts: { env: [Object] } }
...
## 'verbose' option | stream-stream { opts: { verbose: true, stdio: 'pipe', stdout: 'pipe', stde...
...
## 'verbose' option | task { execaOpts: { env: [Object] } }
...
## 'verbose' option | task { opts: { verbose: true, stdio: 'pipe', stdout: 'pipe', stde...
