# Snapshot report for `test/stream.js`

The actual snapshot is saved in `stream.js.snap`.

Generated by [AVA](https://ava.li).

## stream() | stream-buffer { command: { command: 'echo t... stripFinalNewline: true } }
...
## stream() | stream-buffer { task: 'inputFile', command: 'echo' }
...
## stream() | stream-save { command: { command: 'echo t... stripFinalNewline: true } }
...
## stream() | stream-save { task: 'inputFile', command: 'echo' }
...
## stream() | stream-stream { command: { command: 'echo t... stripFinalNewline: true } }
...
## stream() | stream-stream { task: 'inputFile', command: 'echo' }
